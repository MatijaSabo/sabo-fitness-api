package com.sabo.fitness.security.oauth2;


import com.sabo.fitness.utils.CookieUtils;
...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest oAuth2AuthorizationRequest, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        if (oAuth2AuthorizationRequest == null) {
            ...
            CookieUtils.addCookie(httpServletResponse, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME, CookieUtils.serialize(oAuth2AuthorizationRequest), COOKIE_EXPIRE_SECONDS);
            if (StringUtils.isNotEmpty(httpServletRequest.getParameter(REDIRECT_URI_PARAM_COOKIE_NAME))) {
                CookieUtils.addCookie(httpServletResponse, REDIRECT_URI_PARAM_COOKIE_NAME, httpServletRequest.getParameter(REDIRECT_URI_PARAM_COOKIE_NAME), COOKIE_EXPIRE_SECONDS);
            }
        }
    }
